...
require (
	...
	github.com/duosecurity/duo_api_golang v0.0.0-20220428205559-fa137a8ef05b // indirect
...
replace (
	...
	gopkg.in/ory-am/dockertest.v3 v3.8.1 => github.com/ory/dockertest/v3 v3.8.1
)
